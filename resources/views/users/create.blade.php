<!--CREATE AREA  Modal -->
<div class="modal fade" id="create-modal" tabindex="-1" role="dialog" aria-labelledby="modalUserCreate"
     aria-describedby="Crear Usuario">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="modalUserCreate">Crear Usuario</h4>
            </div>
            {!! Form::open(['class'=>'form_noEnter', 'id'=>'form_user_store', 'autocomplete'=>'off','files'=>'true']) !!}
            ...
            <div class="modal-footer bg-success">
                <button class="btn btn-sm btn-primary guardar"><i class="fa fa-save"></i> Guardar</button>
