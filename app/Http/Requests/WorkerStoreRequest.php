...
class WorkerStoreRequest extends Request
{
    /**
    ...
    {
        return [
            'area_id.required'=>'Debe seleccionar el área del trabajador',
            'departamento_id.required'=>'Debe seleccionar el departamento del trabajador',
